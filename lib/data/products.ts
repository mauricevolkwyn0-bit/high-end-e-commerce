...
export const products: Product[] = [
  ...
  {
    id: '10',
    name: 'Velours Noir Smoking Jacket',
    slug: 'velours-noir-smoking-jacket',
    description: 'Conceived for the private hours. This smoking jacket is cut from Italian silk velvet in a deep midnight noir and lined throughout with hand-printed Liberty silk. The shawl collar is faced in grosgrain, the pockets hand-piped. A garment that transforms the wearer the moment it is put on.',
    price: 5000,
    images: [
      'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=900&q=90&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1488161628813-04466f872be2?w=900&q=90&auto=format&fit=crop',
    ...
    sizes: ['44', '46', '48', '50', '52'],
    colors: [
      { name: 'Midnight Noir', hex: '#0D0D1A' },
      { name: 'Burgundy', hex: '#6B1E2A' },
    ],
    stock: 6,
    is_featured: true,
    material: 'Italian silk velvet, Liberty silk lining, grosgrain',
    origin: 'Made in Milan, Italy',
    created_at: '2025-01-01',
  },
  {
    id: '11',
    name: 'Obsidian Pocket Square',
    slug: 'obsidian-pocket-square',
    description: 'The smallest gesture, the loudest statement. Hand-rolled in our Paris atelier from a single square of 12-momme silk habotai, this pocket square carries the OBSIDIAN monogram woven in tone-on-tone thread at the corner. The entry point to the house.',
    price: 1,
    images: [
      'https://images.unsplash.com/photo-1617137968427-85924c800a22?w=900&q=90&auto=format&fit=crop',
    ],
    ...
    stock: 50,
    is_featured: false,
    material: '12-momme silk habotai, hand-rolled hem',
    origin: 'Made in Paris, France',
    created_at: '2025-01-01',
  },
]
